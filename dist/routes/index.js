...
const corral_work_session_routes_1 = __importDefault(require("./corral-work-session.routes"));
...
operationalRouter.use('/corral-work-session', corral_work_session_routes_1.default);
