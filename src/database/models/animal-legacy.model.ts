...
export function createAnimalLegacyModel(
    sequelize: Sequelize
): ModelStatic<Model<AnimalLegacyAttributes, AnimalLegacyCreationAttributes>> {
    class AnimalLegacyModel extends Model<AnimalLegacyAttributes, AnimalLegacyCreationAttributes>
        implements AnimalLegacyAttributes {
    ...
    return AnimalLegacyModel as ModelStatic<Model<AnimalLegacyAttributes, AnimalLegacyCreationAttributes>>;
}
