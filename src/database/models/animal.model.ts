...
export function createAnimalModel(sequelize: Sequelize): ModelStatic<Model<AnimalAttributes, AnimalCreationAttributes>> {
    ...
    return AnimalModel as ModelStatic<Model<AnimalAttributes, AnimalCreationAttributes>>;
}
