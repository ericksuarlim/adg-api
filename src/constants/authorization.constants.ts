...
export const PERMISSION_ROLE_MAP: Record<Permission, UserRole[]> = {
    ...
    [Permission.COMPANY_TENANT_READ]: [UserRole.ADMINISTRATOR, UserRole.RANCH_STAFF, UserRole.SAAS_OWNER],
    ...
    [Permission.OWNER_READ]: [UserRole.RANCH_STAFF, UserRole.ADMINISTRATOR, UserRole.SAAS_OWNER],
    [Permission.OWNER_WRITE]: [UserRole.RANCH_STAFF, UserRole.ADMINISTRATOR, UserRole.SAAS_OWNER],
